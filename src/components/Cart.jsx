...
export default function Button({ theme, styled, click, children }) {
    ...
    return (<div className={` transition-all ease-in-out duration-300  z-40`}>
        <button type="button" onClick={HandlerCheckOut} className="h-[40px] w-[40px] my-1 text-blue-700 bg-[#ffffff] border-[2px] border-[#00095F] font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
            ...
            <span className='inline-block absolute top-[10px] text-[#ffffff] right-[10px] bg-[#00095F] w-[16px] text-[12px] rounded-full border border-[#00095F]'>{
